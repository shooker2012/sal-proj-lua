...
vim.api.nvim_create_user_command('SVNLog', function(arg_table)
	...
	local command_line = string.format('!%s  /command:log /path:"%s"', svn_cmd, path)
...
vim.api.nvim_create_user_command('SVNUpdate', function(arg_table)
	...
	local command_line = string.format('!%s  /command:update /path:"%s"', svn_cmd, path)
	vim.cmd(command_line)
end, {nargs='*', complete="file"})
...
vim.api.nvim_create_user_command('SVNCommit', function(arg_table)
	...
	local command_line = string.format('!%s  /command:commit /path:"%s"', svn_cmd, path)
	vim.cmd(command_line)
end, {nargs='*', complete="file"})
...
vim.api.nvim_create_user_command('SVNRevert', function(arg_table)
	...
	local command_line = string.format('!%s  /command:revert /path:"%s"', svn_cmd, path)
	vim.cmd(command_line)
end, {nargs='*', complete="file"})
...
vim.api.nvim_create_user_command('SVNCleanup', function(arg_table)
	...
	local command_line = string.format('!%s  /command:cleanup /path:"%s"', svn_cmd, path)
	vim.cmd(command_line)
end, {nargs='*', complete="file"})
...
vim.api.nvim_create_user_command('SVNDiff', function(arg_table)
	...
	local command_line = string.format('!%s  /command:diff /path:"%s"', svn_cmd, path)
	vim.cmd(command_line)
end, {nargs='*', complete="file"})
...
vim.api.nvim_create_user_command('SVNBlame', function(arg_table)
	...
	local command_line
	command_line = string.format('!%s  /command:blame /path:"%s" /line:%d', svn_cmd, path, line)
